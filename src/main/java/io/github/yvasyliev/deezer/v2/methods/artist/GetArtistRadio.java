...
public class GetArtistRadio extends AbstractDzPagingIdMethod<Track, ArtistService> {
    public GetArtistRadio(ArtistService artistService, Gson gson, long albumId) {
