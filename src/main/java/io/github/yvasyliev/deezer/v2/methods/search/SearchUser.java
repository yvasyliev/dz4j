...
public class SearchUser extends AbstractDzSearchMethod<User> {
    public SearchUser(SearchService searchService, Gson gson, String q) {
        super(searchService, gson, q);
    }

    @Override
    public CompletableFuture<Page<User, DzSearchMethod<User>>> executeAsync() {
