...
public class SearchPlaylist extends AbstractDzSearchMethod<Playlist> {
    public SearchPlaylist(SearchService searchService, Gson gson, String q) {
        super(searchService, gson, q);
    }

    @Override
    public CompletableFuture<Page<Playlist, DzSearchMethod<Playlist>>> executeAsync() {
