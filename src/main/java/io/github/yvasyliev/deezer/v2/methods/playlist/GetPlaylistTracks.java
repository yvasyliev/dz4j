...
public class GetPlaylistTracks extends AbstractDzPagingIdMethod<Track, PlaylistService> {
    public GetPlaylistTracks(PlaylistService deezerService, Gson gson, long objectId) {
