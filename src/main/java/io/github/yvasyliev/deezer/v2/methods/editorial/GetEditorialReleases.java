...
public class GetEditorialReleases extends AbstractDzPagingIdMethod<Album, EditorialService> {
    public GetEditorialReleases(EditorialService editorialService, Gson gson, long editorialId) {
