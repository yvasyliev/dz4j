...
public interface PlaylistService extends DeezerService {
    ...
    CompletableFuture<Page<User, DzPagingMethod<User>>> getPlaylistFansAsync(@Param("playlistId") long playlistId, @QueryMap Map<String, Object> queryParams);

    @RequestLine(GET + PLAYLIST_RADIO)
    CompletableFuture<Page<Track, DzPagingMethod<Track>>> getPlaylistRadioAsync(@Param("playlistId") long playlistId, @QueryMap Map<String, Object> queryParams);

    @RequestLine(GET + PLAYLIST_TRACKS)
    CompletableFuture<Page<Track, DzPagingMethod<Track>>> getPlaylistTracksAsync(@Param("playlistId") long playlistId, @QueryMap Map<String, Object> queryParams);
}
