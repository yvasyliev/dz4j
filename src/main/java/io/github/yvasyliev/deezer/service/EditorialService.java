...
public interface EditorialService extends DeezerService {
    ...
    CompletableFuture<Page<Editorial, DzPagingMethod<Editorial>>> getEditorialsAsync(@QueryMap Map<String, Object> queryParams);
    ...
    CompletableFuture<Page<Album, DzPagingMethod<Album>>> getEditorialReleasesAsync(@Param("editorialId") long editorialId, @QueryMap Map<String, Object> queryParams);

    @RequestLine(GET + EDITORIAL_SELECTION)
    CompletableFuture<Page<Album, DzPagingMethod<Album>>> getEditorialSelectionAsync(@Param("editorialId") long editorialId, @QueryMap Map<String, Object> queryParams);
}
